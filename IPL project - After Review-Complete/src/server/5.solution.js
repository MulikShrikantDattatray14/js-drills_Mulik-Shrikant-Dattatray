...
// Space Complexity:
// The space complexity is O(t), where t is the number of unique teams in the matchesData that won both the toss and the match. This is because we are storing the result in an object where each team is a key.